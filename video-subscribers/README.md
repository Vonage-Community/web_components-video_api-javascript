...
- `properties` : (Object) the properties used on each video in video subscribers. Find the full list in the [documentation](https://vonage.github.io/conversation-docs/video-js-reference/latest/Session.html#subscribe).
